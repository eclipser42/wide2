...
@interface GRChartView : NSView <NSCoding>
{
	...
	struct _NSRange _dirtyDataRange;	// 160 = 0xa0
...
- (void)reloadDataInRange:(struct _NSRange)fp8;	// IMP=0x4d58096c
- (void)setNeedsToReloadData:(BOOL)fp8;	// IMP=0x4d580a2c
- (BOOL)needsToReloadData;	// IMP=0x4d580a5c
- (void)setNeedsToReloadData:(BOOL)fp8 inRange:(struct _NSRange)fp12;	// IMP=0x4d580a6c
- (BOOL)needsToReloadDataInRange:(struct _NSRange)fp8;	// IMP=0x4d580c68
